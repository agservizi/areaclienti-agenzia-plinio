-- Installazione completa schema AG Servizi Area Personale
-- Eseguire questo script su un database vuoto.
-- Aggiorna la riga USE con il nome del database se differente.

CREATE DATABASE IF NOT EXISTS u427445037_portal
    DEFAULT CHARACTER SET utf8mb4
    DEFAULT COLLATE utf8mb4_unicode_ci;

USE u427445037_portal;
